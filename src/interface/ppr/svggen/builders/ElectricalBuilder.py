...
driverTest.setContainer("InputDriver", "ArduinoUno", {"pin": 15}, {"pin15": ["InputDriver", 1]}, types=['code', 'electrical'])
driverTest.setContainer("OutputDriver", "ArduinoUno", {"pin": 6}, {"pin6": ["OutputDriver", 0]}, types=['code', 'electrical'])
driverTest.make()
